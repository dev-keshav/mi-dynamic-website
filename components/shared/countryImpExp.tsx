            ...
            <div className={styles.turnoverTbs} >
                ...
                <div className={styles.tabcontent} >
                    ...
                    <Row>
                        ...
                        {res &&  <h2>Where  {res.company_name} Imports from ?</h2> }
                        {res &&  <p> {res.company_name} Imports from US 23%, China 21%, Japan 18% and more</p>}
                        </div>
                        </Col>
                        <Col md={7} lg={7}>
                    ...
                    <Row>
                            ...
                            {res &&  <h2>Where  {res.company_name} Exports to ?</h2>}
                                {res &&  <p> {res.company_name} Imports to US 23%, China 21%, Japan 18% and more</p>}
                            </div>
                            </Col>
