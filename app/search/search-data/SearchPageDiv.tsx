...
export default function SearchPageDiv() {
  // ******************
  ...
  const trendData = [
    ...
    },
    {
      ...
      children: [
        "Arcor SAIC",
        "K K G APPORT VENTURES",
        "TOYOTA OTOMOTIV SANAYI TÜRKIYE A.S.",
        "PPNO-BX-0523499KAZI RIAZ KHAN",
        "STAR RAFINERI A.S.",
        "VAKIF KATILIM BANKASI A.S",
        "BOTAS BORU HATLARI ILE PETROL TASIM",
    ...
    },
    {
      ...
      children: [
        ...
        "Iron & Steel Articles",
        "Rubber Cotton Paper and Paperboard",
  ...
  return (
    <section className=" mx-12 grid items-center gap-6 pb-8 pt-6  ">
      <div className="flex flex-col items-center gap-2 ">
        <h1 className="text-3xl font-extrabold leading-tight tracking-tighter md:text-4xl">
          Search Global Trade Data Online
        </h1>
        <p className=" text-lg text-muted-foreground">
          Discover Online 195+ Countries Trade Data by HS Code, Importers,
          Exporter and more
        </p>
      </div>
      ...
      <div className="flex w-full flex-wrap justify-center">
        <div className="mt-10 flex flex-wrap justify-around 2xl:min-w-[1400px] 2xl:max-w-[2800px]">
          {dataArray.map((data, index) => (
            <div
              key={index}
              className={`litdtaSrch`}
              style={{
                margin: "9px",
                textAlign: "center",
                padding: "34px 22px",
      ...
      {trendData.map((trend, index) => (
        <Trend
          key={index}
          head_line={trend.title}
          list_items={trend.children}
        />
      ))}
      <div className="mt-4 flex flex-col items-center justify-center pt-16">
        <h2 className=" mb-5 flex font-roboto text-3xl font-semibold leading-6">
      ...
      <div
        ...
        onMouseEnter={() =>
          document.getElementById("scrollContainer")?.classList.add("paused")
        }
        onMouseLeave={() =>
          document.getElementById("scrollContainer")?.classList.remove("paused")
        }
      >
